...
CREATE TABLE `doc_version` (
  ...
  `bbsAvailable` tinyint DEFAULT NULL,
  ...
  KEY `user_idx` (`user`),
  KEY `title_idx` (`title`),
  CONSTRAINT `title` FOREIGN KEY (`title`) REFERENCES `bbs` (`title`),
...
INSERT INTO `doc_version` VALUES (1,1,'HelloTitle','This is Title','2023-05-22 15:00:00',111);
